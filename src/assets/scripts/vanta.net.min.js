!(function (t, e) {
	...
	(() => {
		...
		function s(t, e) {
			return (
				null == t && (t = 0), null == e && (e = 1), Math.floor(t + Math.random() * (e - t + 1))
			);
		}
		t.r(e),
			t.d(e, { default: () => u }),
		...
		class d extends c {
			...
			genPoint(t, e, i) {
				...
				return (
					...
					(s.r =
						(null == (o = -2) && (o = 0), null == (n = 2) && (n = 1), o + Math.random() * (n - o))),
					this.points.push(s)
				);
			}
			onInit() {
				...
				(this.camera = new p.PerspectiveCamera(25, this.width / this.height, 0.01, 1e4)),
